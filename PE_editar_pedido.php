<?php
    ...
    function PedidoEspecial($conn, $id) {
        ...
        if ($result->num_rows > 0) {
            ...
            return null; // Retorna null si no se encontr�� ning��n registro
        }
    }
...
<div class="container mt-5">
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert" id="mensajeAlertaE" style="display:none;">
        <strong>�0�3Exito!</strong> Pedido guardado exitosamente.
    ...
    <table class="table table-striped" id="tabla">
        ...
        <tbody>
            ...
            // Asegura que todos los arrays tengan el mismo n��mero de elementos
            $numItems = count($skus);
...
<div>
    <script>
        ...
        // Aplicar la validaci��n de caracteres a los nuevos campos
        limitarCaracteres();
    ...
    function verificarCampos(input) {
        // Obtener la fila en la que est�� el input
        var fila = input.parentNode.parentNode;
        
        // Obtener los campos SKU, Descripci��n y Cantidad de la misma fila
        ...
        if (sku && descripcion && cantidad) {
            // Verificar si ya existe una fila vac��a
            if (!existeFilaVacia()) {
                // Si no existe una fila vac��a, agregar una nueva fila
                agregarFila();
            }
        }
    }
    
    // Funci��n para verificar si ya existe una fila vac��a
    function existeFilaVacia() {
        ...
        for (var i = 0; i < filas.length; i++) {
            ...
            // Si hay una fila con SKU, Descripci��n o Cantidad vac��os, retornar true
            if (!sku || !descripcion || !cantidad) {
                return true;
            }
        }
