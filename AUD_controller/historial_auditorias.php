    ...
    try {
        ...
        data.forEach(a => {
            ...
            let statusEvidencia = a.fecha_subida_evidencia 
                ? `<span class="badge bg-success" title="${a.fecha_subida_evidencia}"><i class="bi bi-camera"></i> Subidas</span>` 
                : `<span class="badge bg-secondary"><i class="bi bi-clock"></i> Pendientes</span>`;
