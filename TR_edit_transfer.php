    ...
    <div class="card shadow-lg border-0">
        <div class="card-body p-4">
            <form method="POST" enctype="multipart/form-data" id="editTransferenciaForm">
                ...
                <div class="row g-3 mb-3">
                     <div class="col-md-6">
                         <div id="presupuesto-container" style="display: none;">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label class="form-label">Importe en Dolares</label>
                         <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" name="importedls" id="importedls" class="form-control" value="<?php echo htmlspecialchars($solicitud['importedls']); ?>" step=".01">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="importedls_letra" class="form-label">Importe con Letra (Dolares)</label>
                        <input type="text" name="importedls_letra" id="importedls_letra" class="form-control" value="<?php echo htmlspecialchars($solicitud['importedls_letra']); ?>">
                    </div>
                </div>
