...
try {
    ...
    $sql = 'SELECT b.beneficiario AS nombre_beneficiario, c.categoria AS nombre_categoria, t.id, t.autorizacion_id, t.sucursal_id, t.estado, 
            t.usuario_id, t.fecha_solicitud, t.no_cuenta, t.fecha_vencimiento, t.importe, t.importe_letra, t.importedls, t.importedls_letra, 
    ...
    $sql_update = 'UPDATE transferencias SET estado = "Aprobado", fecha_autorizacion = NOW() WHERE folio = ?';
    ...
    try {
        ...
        <body>
            <div class='container'>
                ...
                <div class='info-row'>
                    <span class='label'>Importe en DLLS:</span>
                    <span class='value'>{$solicitud['importedls']}</span>
                </div>
                
                <div class='info-row'>
                    <span class='label'>Importe con Letra DLLS:</span>
