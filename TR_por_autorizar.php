            ...
            <table class="table table-striped" id="solicitudesTable">
                ...
                <tbody>
                    <?php foreach ($solicitudes as $solicitud): ?>
                        <tr>
                            <td><a href="TR_detalle_transferencias.php?id=<?php echo htmlspecialchars($solicitud['id']); ?>&AT=true"><?php echo htmlspecialchars($solicitud['folio']); ?></a></td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <?php if ($solicitud['estado'] == 'Pendiente'): ?>
                                        <a href="#" 
                                           data-url="TR_controller/aprobar.php?id=<?php echo htmlspecialchars($solicitud['folio']); ?>" 
                                           data-action="Aprobar" 
                                           data-past-action="aprobada"
                                           class="btn btn-success btn-sm btn-accion-solicitud">Aprobar</a>
                                        
                                        <a href="#" 
                                           data-url="TR_controller/rechazar.php?id=<?php echo htmlspecialchars($solicitud['id']); ?>" 
