<?php
ob_start();
session_start(); // Asegurarse de que la sesi贸n est谩 iniciada al principio
include("config/db.php"); // Incluir la configuraci贸n de la base de datos
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php else : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php">Iniciar Sesi贸n</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
...
<!-- Dropdown donde se cargarán las notificaciones -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="notificacionesModalContent">
        <!-- Aquí se cargarán todas las notificaciones -->
      </div>
